...
export function Button({ variant, className, ...props }: ButtonProps) {
  return (
    <button className={button({ variant, className })} {...props} /> // A children que vem dentro da props é passada automaticamente. A className depois concatena com um novo estilo que vem do pai
  );
}
